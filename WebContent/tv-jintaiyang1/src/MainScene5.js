var MainScene5 = cc.Scene.extend({
    onEnter:function () {
        this._super();
...
//  alert("winSize="+size.width+"-"+size.height+"|img="+allwight+"-"+allhight+"="+getFullScale(size,sushi.getContentSize()));
  ...
  this.addChild(sushi);
//  return;
    	  var sushi = new cc.Sprite(res.img_14
    			  );
...
//          alert("winSize="+size.width+"-"+size.height+"|img="+allwight+"-"+allhight+"="+getFullScale(size,sushi.getContentSize()));
    ...
    playPng3:function(){
  	  ...
  	  var size = cc.winSize;
    	  ...
    	  var sushi = new cc.Sprite(res.img_15 );
...
//          alert("winSize="+size.width+"-"+size.height+"|img="+allwight+"-"+allhight+"="+getFullScale(size,sushi.getContentSize()));
    ...
    playPng4:function(){
  	  ...
  	  var size = cc.winSize;
    	  ...
    	  var sushi = new cc.Sprite(res.img_16 );
